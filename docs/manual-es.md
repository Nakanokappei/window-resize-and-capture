...
1. Ejecute **WindowResizeCapture.exe**. Aparecerá brevemente una pantalla de inicio.
...
1. Haga clic en el **icono de Window Resize & Capture** en la bandeja del sistema.
...
La aplicación incluye 13 tamaños preestablecidos integrados:
...
- No son ventanas de la propia aplicación Window Resize & Capture
